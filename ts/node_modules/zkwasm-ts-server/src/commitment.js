...
export function commitmentHexToHexString(x, y) {
...
export async function getImageCommitmentHexStrings(imageHash) {
    ...
    return commitmentHexToHexString("0x" + xHexString[0].slice(2).padStart(64, "0"), "0x" + yHexString[0].slice(2).padStart(64, "0"));
}
