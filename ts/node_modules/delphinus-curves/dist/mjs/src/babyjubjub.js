...
export class CurveField {
    v;
    get modulus() {
        return new BN("21888242871839275222246405745257275088614511777268538073601725287587578984328", 10);
    }
    constructor(v) {
        if (!(v instanceof BN)) {
            v = new BN(v);
...
const constants = {
    ...
    a: new Field(168700),
    d: new Field(168696),
    gX: new Field(new BN("16540640123574156134436876038791482806971768689494387082833631921987005038935", 10)),
    gY: new Field(new BN("20819045374670962167435360035096875258406992893633759881276124905556507972311", 10)),
};
export class Point {
    x;
    y;
