...
const babyjubjub_1 = require("../src/babyjubjub");
const prik = babyjubjub_1.PrivateKey.random();
...
const sign = prik.sign(new bn_js_1.BN(0).toArray('be', 64));
...
let l = babyjubjub_1.Point.base.mul(sign[1]);
let r = new babyjubjub_1.Point(sign[0][0], sign[0][1]).add(pubk.key.mul(new bn_js_1.BN((0, sha256_1.default)(sign[0][0].toArray('be', 32)
