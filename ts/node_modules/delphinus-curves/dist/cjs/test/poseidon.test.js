...
const poseidon_1 = require("../src/poseidon");
const config_1 = require("../src/config");
let hasher = new poseidon_1.Poseidon(config_1.config);
hasher.update([new field_1.Field(1)]);
...
let input = Array(config_1.config.t).fill(new field_1.Field(1));
hasher = new poseidon_1.Poseidon(config_1.config);
hasher.update(input);
hash = hasher.squeeze();
...
{
    let input = Array(config_1.config.rate).fill(new field_1.Field(1));
    let hasher = new poseidon_1.Poseidon(config_1.config);
